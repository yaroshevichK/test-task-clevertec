...
import static task.clevertec.util.Constants.MSG_WRONG_ACC;
...
public class TransferMoney implements Command {
    ...
    private Account chooseTransferAccount() {
        ...
        do {
            ...
            accountTransfer = accountService.getOtherUsersAccountByNumber(user, number);
            if (accountTransfer == null) {
                OUT.println(MSG_WRONG_ACC);
            } else {
                break;
            }
    ...
    public String execute() {
        ...
        Account accountTransfer = chooseTransferAccount();
        if (accountTransfer == null) {
            return EMPTY_STRING;
        }
        ...
        try {
            ...
            Transaction transaction = transactionService.createTransferMoney(account, amount, accountTransfer, note);
            if (transaction != null) {
